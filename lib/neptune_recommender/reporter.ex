defmodule NeptuneRecommender.Reporter do
  ...
  def start_link(_) do
    ...
    GenServer.start_link(
      __MODULE__,
      {output_file, output_file_signs, output_file_info, error_file, 0, 0, 0, 0, start_date_time},
      name: @me
    )
  end
  ...
  def recommendation_generated(user_id, petition_id, title) do
    GenServer.cast(@me, {:recommendation_generated, user_id, petition_id, title})
  end

  def recommendation_generated_sign(user_id, petition_id, title) do
    GenServer.cast(@me, {:recommendation_generated_sign, user_id, petition_id, title})
  end
  ...
  def handle_cast(
    ...
    {:noreply,
     {output_file, output_file_signs, output_file_info, error_file, total_items_processed + 1,
      total_item_errors, time_span_processed + 1, recs_generated, start_date_time}}
  end

  def handle_cast(
        {:recommendation_generated, user_id, petition_id, title},
        {output_file, output_file_signs, output_file_info, error_file, total_items_processed,
         total_item_errors, time_span_processed, recs_generated, start_date_time}
      ) do
    ...
    {:noreply,
     {output_file, output_file_signs, output_file_info, error_file, total_items_processed,
      total_item_errors, time_span_processed, recs_generated + 1, start_date_time}}
  end

  def handle_cast(
        {:recommendation_generated_sign, user_id, petition_id, title},
        {output_file, output_file_signs, output_file_info, error_file, total_items_processed,
         total_item_errors, time_span_processed, recs_generated, start_date_time}
      ) do
  ...
  def handle_cast(
    ...
    {:noreply,
     {output_file, output_file_signs, output_file_info, error_file, total_items_processed,
      total_item_errors + 1, time_span_processed, recs_generated, start_date_time}}
  end

  def handle_info(
        :print_report,
        {output_file, output_file_signs, output_file_info, error_file, total_items_processed,
         total_item_errors, time_span_processed, recs_generated, start_date_time} = state
      ) do
  ...
  def handle_info(
    ...
    {:noreply,
     {output_file, output_file_signs, output_file_info, error_file, total_items_processed,
      total_item_errors, 0, recs_generated, start_date_time}}
  end
end
